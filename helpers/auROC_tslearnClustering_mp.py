...
def mp_optimalK(data, output_folder, number_of_cores=1, maxClusters=10, boot_n=10, sk_factor=1, multiProcess=False, use_gpu=True):
    """
...
def run_ts_clustering(data_dict, SETTINGS_DICT):
    ...
    for cur_col in run_dict.keys():
        ...
        k, (gapStat_means, gapStat_sks) = mp_optimalK(relevant_snippet, output_folder=output_path,
                                                      ...
                                                      sk_factor=sk_factor, multiProcess=do_multiprocess, use_gpu=use_gpu)
